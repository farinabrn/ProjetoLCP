...
INSERT INTO `banco` VALUES (1,'Itaú');
...
INSERT INTO `conta` VALUES (1,'conta',100,1,'');
...
INSERT INTO `contabancaria` VALUES (1,'5555','55555',1),(2,'','',1);
...
CREATE TABLE `despesa` (
  ...
  KEY `fk_idUsuario_idx` (`idUsuarioPagador`),
  CONSTRAINT `fk_idUsuarioDesp` FOREIGN KEY (`idUsuarioPagador`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `despesa` VALUES (1,1,'teste',100,'\0'),(2,1,'teste',100,'');
...
INSERT INTO `divida` VALUES (1,1,1,'teste',50,'\0'),(2,1,1,'teste',50,'\0');
...
INSERT INTO `usuario` VALUES (1,'Guilherme','etgetg','000.000.000-00','1995-01-19 02:00:00','1995-01-19 02:00:00',0,'(19) 9999-9999','(19) 99999-9999','ethgerthgetg',1),(2,'teste','','   .   .   -  ','2001-01-01 02:00:00','2001-01-01 02:00:00',0,'(  )     -    ','(  )      -    ','',2);
...
-- Dump completed on 2015-08-26 15:54:23
