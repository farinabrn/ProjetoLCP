...
public class DividaCadastro extends javax.swing.JFrame {
    ...
    private void salvar() {
        ...
        JOptionPane.showMessageDialog(null, "Dívida incluída com sucesso!");
     }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DividaCadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
