...
public class UsuarioCadastro extends JFrame {
    ...
    public UsuarioCadastro(Usuario usuario) {
        ...
        if (usuario != null) {
            ...
            String dataInicio = new SimpleDateFormat("dd/MM/yy").format(usuario.getDataInicio());
            String dataTermino = new SimpleDateFormat("dd/MM/yy").format(usuario.getDataTermino());
            
            textDataInicio.setText(dataInicio);
            textDataTermino.setText(dataTermino);
      ...
      if (this.idUsuario == null) {
          try {
              usuarioController.adicionarUsuario(null, contaBancaria, textNome.getText(), textApelido.getText(),
                      textCPF.getText(),
                      textDataInicio.getText().isEmpty() ? null : (Date) formatter.parse(textDataInicio.getText()),
                      textDataTermino.getText().isEmpty() ? null : (Date) formatter.parse(textDataTermino.getText()),
                      comboBoxSituacao.getSelectedIndex(),
                      textTelefoneCel.getText(),
                      textTelefoneRes.getText(),
                      textEmail.getText());
